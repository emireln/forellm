          ...
          return (
            <div
              ...
              className={cn(
                ...
                isCurrent && 'bg-zinc-800/50 ring-1 ring-cyan-500/30'
              )}
            >
              <span
                className={cn(
              ...
              <span className="w-14 shrink-0 text-zinc-500">{q.quality}</span>
              ...
              <span
                className={cn(
                  ...
                  fits ? 'text-zinc-300' : 'text-red-400'
                )}
              >
                {sizeGb.toFixed(1)} GB
              </span>
              ...
              {isCurrent && (
                <span className="shrink-0 rounded bg-cyan-500/10 px-1 py-0.5 text-[9px] text-cyan-400">
                  BEST
                </span>
              )}
            </div>
