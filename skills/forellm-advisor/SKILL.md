...
forellm recommend --json --use-case reasoning --limit 3
forellm recommend --json --use-case chat --limit 3
```
...
```bash
forellm recommend --json --min-fit good --limit 10
```
...
1. Run `forellm --json system` to show hardware summary
2. Run `forellm recommend --json --limit 5` to get top picks
...
1. Run `forellm recommend --json --use-case coding --limit 3`
