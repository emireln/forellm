...
use forellm_core::fit::{FitLevel, InferenceRuntime, ModelFit, RunMode};
use forellm_core::hardware::SystemSpecs;
use forellm_core::models::ModelDatabase;
use forellm_core::providers::{ModelProvider, OllamaProvider, PullEvent};
use serde::Serialize;
use std::sync::Mutex;
use tauri::State;
...
struct AppState {
    ...
    pull_handle: Mutex<Option<forellm_core::providers::PullHandle>>,
}
