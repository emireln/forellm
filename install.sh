#!/bin/sh
# ForeLLM installer
# Usage: curl -fsSL https://raw.githubusercontent.com/emireln/forellm/main/install.sh | sh
#        curl -fsSL ... | sh -s -- --local   # Install to ~/.local/bin (no sudo)
#
# Downloads the latest ForeLLM release from GitHub and installs
