#!/usr/bin/env python3
"""
Local API validation tests for ForeLLM serve.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run ForeLLM REST API validation tests")
    parser.add_argument("--base-url", default="http://127.0.0.1:8787", help="API base URL")
    parser.add_argument(
        "--spawn",
        action="store_true",
        help="Spawn forellm serve automatically (requires cargo in PATH)",
    )
    parser.add_argument(
        "--project-root",
